...
>
> In fact, the Republican party only care about the 'child' (biologically speaking by definition they are not yet a human being) when they're are not born yet. We can see that historically the GOP have launched cultural attacks on Biden's plan for childcare fundings, education and family leave. Trump's policies have lead to family seperation at borders. Refusing to keep children safe from Covid-19 through blocking mask mandates. Resisting the prot4ection of children through being against background checks after the recent mass shootings. These are just a couple of examples. Clearly, 'children' only matter when they're not born yet.
>
